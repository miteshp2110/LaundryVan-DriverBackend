...
const getServiceDetails = async (req, res) => {
  try {
    ...
    const query =
      "select category.id as cId, category.name as category, items.id as itemId, items.name as item , items.price as price , items.iconUrl as iconUrl from category join items on items.category_id = category.id where service_id = ?";
